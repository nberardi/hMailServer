...
namespace UnitTest.API
{
   ...
   public class Message : TestFixtureBase
   {
      ...
      public void TestAddTextDuringSendingAttachment()
      {
         ...
         mail.From = new System.Net.Mail.MailAddress("test@test.se");
      ...
      [Test]
      [Description("Test to update a subject in a message with no message-wide character set (should default to utf-8)")]
