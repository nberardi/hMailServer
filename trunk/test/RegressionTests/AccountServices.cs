...
namespace UnitTest.Services
{
    ...
    public class AccountServices : TestFixtureBase
    {
        ...
        public void TestForwarding()
        {
            ...
            // Create a test account
            // Fetch the default domain
            hMailServer.Account oAccount1 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "Forward1@test.com", "test");
            hMailServer.Account oAccount2 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "Forward2@test.com", "test");
        ...
        public void TestLongEmailAddresses()
        {
            ...
            // Create a test account
            // Fetch the default domain
            hMailServer.Account oAccount1 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "Account1123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890@test.com", "test");
        ...
        public void TestAddressContainingSingleQuote()
        {
            ...
            // Create a test account
            // Fetch the default domain
            hMailServer.Account oAccount1 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "Addr'ess1@test.com", "test");
            hMailServer.Account oAccount2 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "Addr'ess2@test.com", "test");
        ...
        public void ConfirmSingleReturnPathAfterRuleForward()
        {
            ...
            hMailServer.Account oAccount1 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "account-a@test.com", "test");
            hMailServer.Account oAccount2 = SingletonProvider<Utilities>.Instance.AddAccount(_domain, "account-b@test.com", "test");

            // Set up a rule to trash the message.
            hMailServer.Rule oRule = oAccount1.Rules.Add();
            oRule.Name = "Criteria test";
            oRule.Active = true;
