...
Begin VB.UserControl PageSelectFile 
   ...
   ScaleHeight     =   3570
   ScaleWidth      =   6945
   Begin VB.ListBox lstIMailDomains 
      Height          =   1635
      Left            =   720
      Style           =   1  'Checkbox
      TabIndex        =   2
...
Private Function IWizardPage_Initialize(oWizard As Wizard) As Variant
   ...
   Set oColl = GetIMailDomains
   
   Dim i As Long
   For i = 1 To oColl.Count
      lstIMailDomains.AddItem oColl(i)
   Next i
End Function
...
Private Function IWizardPage_OnLeavePage(iButton As Button) As Boolean
   ...
   Dim i As Long
   For i = 0 To lstIMailDomains.ListCount - 1
      If lstIMailDomains.Selected(i) = True Then
         g_oIMailDomains.Add lstIMailDomains.List(i)
      End If
