...
ALTER TABLE hm_messages ADD messageflags tinyint NOT NULL DEFAULT 0

update hm_messages set messageflags = messageflags | 1 where messageflagseen = 1
...
alter table hm_messages drop column messageflagseen
