...
namespace HM
{
   ...
   IMAPResult
   IMAPCommandLIST::ExecuteCommand(boost::shared_ptr<HM::IMAPConnection> pConnection, boost::shared_ptr<IMAPCommandArgument> pArgument)
   {
      ...
      boost::shared_ptr<IMAPFolders> pFolders = pConnection->GetAccountFolders();
      boost::shared_ptr<IMAPFolders> pPublicFolders = pConnection->GetPublicFolders();
