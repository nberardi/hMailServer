...
namespace HM
{
   ...
   void
   IMAPSimpleCommandParser::Parse(boost::shared_ptr<IMAPCommandArgument> pArgument)
   {
      ...
      while (1)
      {
         ...
         boost::shared_ptr<IMAPSimpleWord> pWord = boost::shared_ptr<IMAPSimpleWord>(new IMAPSimpleWord);
   ...
   */
   ...
   IMAPSimpleCommandParser::UnliteralData()
   {
      ...
      {
         boost::shared_ptr<IMAPSimpleWord> pWord = Word(i);
   ...
   boost::shared_ptr<IMAPSimpleWord>
   IMAPSimpleCommandParser::QuotedWord()
   {
      std::vector<boost::shared_ptr<IMAPSimpleWord> >::iterator iterWord = m_vecParsedWords.begin();
      ...
      boost::shared_ptr<IMAPSimpleWord> pEmpty;
      return pEmpty;
   }
   ...
   String 
   IMAPSimpleCommandParser::GetParamValue(boost::shared_ptr<IMAPCommandArgument> pArguments, int iParamIndex)
   //---------------------------------------------------------------------------()
   // DESCRIPTION:
