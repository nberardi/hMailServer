...
STDMETHODIMP InterfaceLinks::get_Alias(long DBID, IInterfaceAlias **pVal)
{
   try
   {
      ...
      boost::shared_ptr<HM::Alias> pAlias = boost::shared_ptr<HM::Alias>(new HM::Alias);
...
STDMETHODIMP InterfaceLinks::get_DistributionList(long DBID, IInterfaceDistributionList **pVal)
{
   try
   {
      ...
      boost::shared_ptr<HM::DistributionList> pList = boost::shared_ptr<HM::DistributionList>(new HM::DistributionList);
