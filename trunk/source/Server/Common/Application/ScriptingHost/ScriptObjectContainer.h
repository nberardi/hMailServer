...
namespace HM
{
   ...
   public:
      ...
      void AddObject(const String &sName, boost::shared_ptr<void> pObj, ScriptObject::ObjectType type);
   ...
   private:
      ...
      map<String, boost::shared_ptr<ScriptObject> > m_mapObjects;
   };
}