...
namespace HM
{
   ...
   public:
      ...
      boost::shared_ptr<ACLPermission> GetPermissionForAccount(__int64 iAccountID);
      boost::shared_ptr<ACLPermission> GetPermissionForGroup(__int64 iGroupID);
      bool DeletePermissionsForAccount(__int64 iAccountID);

      bool PreSaveObject(boost::shared_ptr<ACLPermission> pPermission, XNode *pNode);
   protected:
