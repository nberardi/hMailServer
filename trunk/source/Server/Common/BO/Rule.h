...
namespace HM
{
   ...
   public:
      ...
      boost::shared_ptr<RuleCriterias> GetCriterias();
      boost::shared_ptr<RuleActions> GetActions();
   ...
   private:
      ...
      boost::shared_ptr<RuleCriterias> m_pCriterias;
      boost::shared_ptr<RuleActions> m_pActions;
