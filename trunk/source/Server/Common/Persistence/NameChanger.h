...
namespace HM
{
   ...
   public:
      ...
      bool RenameDomain(const String& oldDomainName, boost::shared_ptr<Domain> pDomain, String &errorMessage);
      bool RenameAccount(const String& oldAccountName, boost::shared_ptr<Account> pAccount, String &errorMessage);
