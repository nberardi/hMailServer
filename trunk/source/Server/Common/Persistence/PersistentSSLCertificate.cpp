...
namespace HM
{
   ...
   bool
   PersistentSSLCertificate::DeleteObject(boost::shared_ptr<SSLCertificate> pObject)
   {
   ...
   bool 
   PersistentSSLCertificate::ReadObject(boost::shared_ptr<SSLCertificate> pObject, boost::shared_ptr<DALRecordset> pRS)
   {
   ...
   bool 
   PersistentSSLCertificate::SaveObject(boost::shared_ptr<SSLCertificate> pObject, String &errorMessage)
   {
   ...
   bool 
   PersistentSSLCertificate::SaveObject(boost::shared_ptr<SSLCertificate> pObject)
   {
