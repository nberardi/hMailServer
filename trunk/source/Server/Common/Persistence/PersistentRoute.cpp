...
namespace HM
{
   ...
   bool
   PersistentRoute::DeleteObject(boost::shared_ptr<Route> pRoute)
   {
      if (pRoute->GetID() == 0)
         return false;
   ...
   bool 
   PersistentRoute::SaveObject(boost::shared_ptr<Route> pRoute)
   {
      String errorMessage;
   ...
   bool 
   PersistentRoute::SaveObject(boost::shared_ptr<Route> pRoute, String &sErrorMessage)
   {
   ...
   bool
   PersistentRoute::ReadObject(boost::shared_ptr<Route> pRoute, long lID)
   {
   ...
   bool 
   PersistentRoute::ReadObject(boost::shared_ptr<Route> pRoute, boost::shared_ptr<DALRecordset> pRS)
   {
