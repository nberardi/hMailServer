...
namespace HM
{
   ...
   bool
   PersistentACLPermission::DeleteObject(boost::shared_ptr<ACLPermission> pObject)
   {
   ...
   bool 
   PersistentACLPermission::ReadObject(boost::shared_ptr<ACLPermission> pObject, boost::shared_ptr<DALRecordset> pRS)
   {
   ...
   bool
   PersistentACLPermission::Validate(boost::shared_ptr<ACLPermission> pObject)
   {
   ...
   bool 
   PersistentACLPermission::SaveObject(boost::shared_ptr<ACLPermission> pObject, String &errorMessage)
   {
      return SaveObject(pObject);
   }

   bool 
   PersistentACLPermission::SaveObject(boost::shared_ptr<ACLPermission> pObject)
   {
      if (!Validate(pObject))
         return false;
