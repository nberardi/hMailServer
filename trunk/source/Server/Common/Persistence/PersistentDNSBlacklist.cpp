...
namespace HM
{
   ...
   bool
   PersistentDNSBlackList::DeleteObject(boost::shared_ptr<DNSBlackList> pObject)
   {
   ...
   bool 
   PersistentDNSBlackList::ReadObject(boost::shared_ptr<DNSBlackList> pObject, boost::shared_ptr<DALRecordset> pRS)
   {
   ...
   bool 
   PersistentDNSBlackList::SaveObject(boost::shared_ptr<DNSBlackList> pObject, String &errorMessage)
   {
      return SaveObject(pObject);
   }

   bool 
   PersistentDNSBlackList::SaveObject(boost::shared_ptr<DNSBlackList> pObject)
   {
