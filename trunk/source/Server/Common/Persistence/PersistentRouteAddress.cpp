...
namespace HM
{
   ...
   bool
   PersistentRouteAddress::SaveObject(boost::shared_ptr<RouteAddress> pRA, String &errorMessage)
   {
   ...
   bool
   PersistentRouteAddress::SaveObject(boost::shared_ptr<RouteAddress> pRA)
   {
   ...
   bool
   PersistentRouteAddress::DeleteObject(boost::shared_ptr<RouteAddress> pRA)
   {
   ...
   bool
   PersistentRouteAddress::ReadObject(boost::shared_ptr<RouteAddress> pRA, long lID)
   {
   ...
   bool 
   PersistentRouteAddress::ReadObject(boost::shared_ptr<RouteAddress> pRA, boost::shared_ptr<DALRecordset> pRS)
   {
