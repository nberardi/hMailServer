...
namespace HM
{
   ...
   bool
   PersistentGreyListingWhiteAddress::DeleteObject(boost::shared_ptr<GreyListingWhiteAddress> pObject)
   {
   ...
   bool 
   PersistentGreyListingWhiteAddress::ReadObject(boost::shared_ptr<GreyListingWhiteAddress> pObject, boost::shared_ptr<DALRecordset> pRS)
   {
   ...
   bool 
   PersistentGreyListingWhiteAddress::SaveObject(boost::shared_ptr<GreyListingWhiteAddress> pObject, String &errorMessage)
   {
   ...
   bool 
   PersistentGreyListingWhiteAddress::SaveObject(boost::shared_ptr<GreyListingWhiteAddress> pObject)
   {
   ...
   PersistentGreyListingWhiteAddress::IsSenderWhitelisted(const String &address)
   {
     SQLCommand command1("SELECT COUNT(*) as c FROM hm_greylisting_whiteaddresses "
      ...
      boost::shared_ptr<DALRecordset> pRS = Application::Instance()->GetDBManager()->OpenRecordset(command1);
