...
namespace HM
{
   ...
   bool
   PersistentIncomingRelay::DeleteObject(boost::shared_ptr<IncomingRelay> pSR)
   {
      assert(pSR->GetID());
   ...
   bool
   PersistentIncomingRelay::ReadObject(boost::shared_ptr<IncomingRelay> pSR, const SQLCommand &command)
   {
