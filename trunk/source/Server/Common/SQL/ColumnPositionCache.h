...
namespace HM
{
   ...
   public:
      ...
      boost::shared_ptr<ColumnPositions> GetPositions(const AnsiString &sqlStatement, DALRecordset *pRecordset);

   private:

      std::map<AnsiString, boost::shared_ptr<ColumnPositions> > _mapTableColumns;
   };
}