...
namespace HM
{
   ...
   class MySQLConnection : public DALConnection, public boost::enable_shared_from_this<MySQLConnection>
   {
   public:
      ...
      enum Server
      {
	   ...
	   MySQLConnection(boost::shared_ptr<DatabaseSettings> pSettings);
