...
namespace HM
{
   ...
   public:
	   ...
	   virtual ~MessageUtilities();
		...
		static bool MoveToIMAPFolder(boost::shared_ptr<Message> pMessage, __int64 iAccountID, const String &sFolderName, bool bAutoSubscribe, bool bSetByGlobalRule,  __int64 &iResultAccount, __int64 &iResultFolder);
      ...
      static bool RetrieveOriginatingAddress(boost::shared_ptr<Message> pMessage, String &hostName, IPAddress &address);
      ...
      static String GetSendersIP(boost::shared_ptr<Message> pMessage);

      static bool CopyToIMAPFolder(boost::shared_ptr<Message> pMessage, int iDestinationFolderID);
   ...
   private:
      ...
      static boost::shared_ptr<MimeHeader> _GetMessageHeader(boost::shared_ptr<Message> pMessage);
