...
namespace HM
{
   ...
   bool 
   SignatureAdder::SetSignature(boost::shared_ptr<Message> pMessage, 
   ...
   bool 
   SignatureAdder::_GetMessageIsReply(boost::shared_ptr<MessageData> &pMessageData)
   {
   ...
   bool 
   SignatureAdder::_GetMessageIsLocal(boost::shared_ptr<Message> pMessage)
   {
      ...
      std::vector<boost::shared_ptr<MessageRecipient> >::iterator iter = vecRecipients.begin();
      std::vector<boost::shared_ptr<MessageRecipient> >::iterator iterEnd = vecRecipients.end();
